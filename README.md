...
## Building
Place rtmidi library into the same folder as your cloned repo. The rtmidi is just an include, you don't (can't?) compile it. The structure should look like this:
...
### Building on Windows
I used TDM-GCC and Code::Blocks and was able to build it, but it didn't work very well. This is one of the parts of the project where I would welcome help very much, because I don't know a lot about development for Windows and there's probably something obvious I missed.
